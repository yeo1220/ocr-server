...
from llm_refine import _extract_json, _row_to_data_index, _validate_rows
...
class LlmRefineTests(unittest.TestCase):
    ...
    def test_row_to_data_index(self):
        self.assertIsNone(_row_to_data_index(0, 0))
        self.assertEqual(_row_to_data_index(1, 0), 0)
        self.assertEqual(_row_to_data_index(2, 0), 1)
