...
# GPU memory split: Gemma 4 MoE ~38% + Qwen2.5-VL-72B-AWQ ~55% (+ host OCR API)
export CHAT_GPU_MEMORY_UTIL="${CHAT_GPU_MEMORY_UTIL:-0.38}"
export VL_GPU_MEMORY_UTIL="${VL_GPU_MEMORY_UTIL:-0.55}"
export CHAT_MAX_MODEL_LEN="${CHAT_MAX_MODEL_LEN:-32768}"
...
export VL_HF_MODEL="${VL_HF_MODEL:-Qwen/Qwen2.5-VL-32B-Instruct-AWQ}"
export VL_MODEL_DIR="${VL_MODEL_DIR:-Qwen2.5-VL-32B-Instruct-AWQ}"
