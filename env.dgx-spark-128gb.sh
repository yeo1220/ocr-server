...
export VL_HF_MODEL="${VL_HF_MODEL:-NCSOFT/VARCO-VISION-2.0-1.7B}"
export VL_MODEL_DIR="${VL_MODEL_DIR:-VARCO-VISION-2.0-1.7B}"
export VLLM_VL_MODEL="${VLLM_VL_MODEL:-qwen-vl-ocr}"
export VLLM_VL_BASE_URL="${VLLM_VL_BASE_URL:-http://127.0.0.1:8003/v1}"
export VLLM_VL_MAX_TOKENS="${VLLM_VL_MAX_TOKENS:-4096}"
export VLLM_VL_TIMEOUT="${VLLM_VL_TIMEOUT:-240}"
